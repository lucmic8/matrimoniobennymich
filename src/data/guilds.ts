...
export const guilds: Guild[] = [
  ...
  },
  {
    id: 'antermoia',
    name: 'Antermoia',
    subtitle: 'Cima dal paesaggio lunare',
    description: 'Guardiani delle albe dorate tra le vette alpine',
    fullDescription: 'Antermoia, con i suoi 3.264 metri, è una delle vette più spettacolari del gruppo del Catinaccio. Conosciuto per le sue pareti che si tingono di rosa e oro durante l\'alba e il tramonto, questo monte incarna la magia dell\'enrosadira. I guerrieri di questa cima sono maestri nell\'arte della trasformazione e sanno trovare la bellezza anche nei momenti più difficili, proprio come la montagna trasforma la luce in spettacolo.',
  ...
  },
  {
    ...
    fullDescription: 'Il Piz Boè, con i suoi 3.152 metri, è la vetta più alta del gruppo del Sella. Spesso avvolto dalle nuvole e battuto dai venti, questo monte è il regno delle tempeste e dei fenomeni atmosferici più spettacolari. Gli scalatori di questa cima affrontano con coraggio le avversità e sono capaci di trovare la loro forza nelle sfide più difficili e di trasformare ogni tempesta in un\'opportunità di crescita.',
  ...
  },
  {
    ...
    fullDescription: 'Plan de Corones, con i suoi 2.275 metri, è famoso per offrire uno dei panorami più spettacolari delle Alpi. Da questa vetta si possono ammirare oltre 400 cime alpine in un colpo d\'occhio, dalle Dolomiti alle Alpi Centrali. Questa montagna rappresenta la visione d\'insieme e la capacità di vedere il quadro completo. I membri di questa cima sono visionari e strateghi, capaci di cogliere le connessioni tra le cose e di avere sempre una prospettiva ampia su ogni situazione.',
